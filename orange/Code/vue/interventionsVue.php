...
<br>
    ...
    <div class="bouton-statut">
    <div class="statut-confirmer">
        <form method="post">
            <button type="submit" class="btn btn-primary" name="filtrerInterventionConfirmer" value="filtrerInterventionConfirmer" >Intervention confirmer</button>
        </form>
    </div>

    <div class="statut-confirmer">
    <form method="post">
        <button type="submit" class="btn btn-primary" name="filtrerInterventionEnCours" value="filtrerInterventionEnCours" >Intervention en cours</button>
    </form>
    </div>

    <div class="statut-confirmer">
    <form method="post">
        <button type="submit" class="btn btn-primary" name="filtrerInterventionAnnuler" value="filtrerInterventionAnnuler" >Intervention annulée</button>
    </form>
    </div>
  </div>
    ...
    <table class="table table-bordered ">
        ...
        <tbody>
            <?php
                ...
                }elseif(isset($lesInterventions) && ($_POST['idMateriel'])){
                    foreach ($lesMateriaux as $unMateriel)
                        {
                            echo
                            '
