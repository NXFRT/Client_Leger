...
require_once("modele/interventionsModele.php");
    ...
    if(isset($_POST["filtrerInterventionConfirmer"])) 
    {
        $lesInterventions = $interventionControleur->searchInterventionConfirmer();
    }

    if(isset($_POST["filtrerInterventionEnCours"])) 
    {
        $lesInterventions = $interventionControleur->searchInterventionEnCours();
    }

    if(isset($_POST["filtrerInterventionAnnuler"])) 
    {
        $lesInterventions = $interventionControleur->searchInterventionAnnuler();
    }
    ...
    class interventionControleur
    {
        ...
        public function searchInterventionConfirmer()
        {
            return $this->interventionModele->searchInterventionConfirmer();
        }

        public function searchInterventionEnCours()
        {
            return $this->interventionModele->searchInterventionEnCours();
        }

        public function searchInterventionAnnuler()
        {
            return $this->interventionModele->searchInterventionAnnuler();
        }
        ...
        public function selectClientIdMaterials($idMateriel)
        {
            return $this->interventionModele->selectClientIdMaterials($idMateriel);
        }
