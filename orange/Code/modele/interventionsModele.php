<?php
    ...
    class interventionsModele extends BDD
    {
        ...
        {
            $requete = "SELECT * FROM intervention WHERE statut = 'Confirmé';";
            $select = $this->bdd->prepare($requete);
            $select->execute();
            return $select->fetchAll();
        }
        ...
        {
            $requete = "SELECT * FROM intervention WHERE statut = 'En cours';";
            $select = $this->bdd->prepare($requete);
            $select->execute();
            return $select->fetchAll();
        }
        ...
        {
            $requete = "SELECT * FROM intervention WHERE statut = 'Annuler';";
            $select = $this->bdd->prepare($requete);
            $select->execute();
            return $select->fetchAll();
        }
